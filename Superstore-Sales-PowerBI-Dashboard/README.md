...
# │   └── Superstore\_Sales\_Dashboard.pbix
...
# │   └── superstore\_powerbi\_import.csv
...
# sqlite3 superstore\_real.db < analysis\_queries.sql
...
# Open `Superstore\_Sales\_Dashboard.pbix` using \*\*Power BI Desktop\*\* to explore the interactive dashboard, filters, KPIs, and visualizations.
